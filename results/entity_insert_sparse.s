	.file	"entity_insert_sparse.ce323d09508174cf-cgu.0"
...
entity_insert:
	...
	testl	%eax, %eax
	je	.LBB17_165
	movabsq	$7998890886330344604, %r12
	movl	20(%r13), %eax
	movl	%eax, 40(%rsp)
	movl	24(%r13), %r15d
	movl	28(%r13), %eax
...
.LBB17_3:
	...
	xorq	%r12, %r11
	movq	(%rsi,%r10,8), %rbx
	movabsq	$-9038529977393613872, %rbp
	xorq	%rbp, %rbx
	orq	%r11, %rbx
	je	.LBB17_7
	leal	-1(%r9), %r10d
...
.LBB17_8:
	...
	xorl	%ecx, %ecx
	pcmpeqd	%xmm1, %xmm1
	movabsq	$7998890886330344604, %r8
	movq	%r12, %r9
	movabsq	$-9038529977393613872, %r15
.LBB17_10:
	andq	%rdx, %r9
	movdqu	(%rax,%r9), %xmm2
	movdqa	%xmm2, %xmm3
...
.LBB17_15:
	...
	xorl	%r12d, %r12d
	pcmpeqd	%xmm1, %xmm1
	movabsq	$7998890886330344604, %r9
.LBB17_16:
	andq	%rdx, %r10
	movdqu	(%rax,%r10), %xmm2
	movdqa	%xmm2, %xmm3
...
.LBB17_17:
	...
	movq	(%rcx,%rsi), %r15
	movq	%r9, %r8
	movabsq	$-9038529977393613872, %r9
	xorq	%r9, %r15
	orq	%r14, %r15
	je	.LBB17_22
	leal	-1(%r11), %esi
...
.LBB17_27:
	...
	callq	core::ptr::drop_in_place<bevy_ecs::component::required::RequiredComponents>
	movaps	176(%rsp), %xmm0
	movups	%xmm0, 168(%r12,%rbx)
	movaps	160(%rsp), %xmm0
	movups	%xmm0, 152(%r12,%rbx)
	movaps	144(%rsp), %xmm0
	movups	%xmm0, 136(%r12,%rbx)
	movdqa	80(%rsp), %xmm0
	movdqa	96(%rsp), %xmm1
	movdqa	112(%rsp), %xmm2
	movdqa	128(%rsp), %xmm3
	movdqu	%xmm3, 120(%r12,%rbx)
	movdqu	%xmm2, 104(%r12,%rbx)
	movdqu	%xmm1, 88(%r12,%rbx)
	movdqu	%xmm0, 72(%r12,%rbx)
	jmp	.LBB17_29
.LBB17_28:
	movq	%rdi, %r15
	movq	-8(%rsi), %rcx
...
.LBB17_29:
	...
	cmpq	608(%rbx), %rbp
	movabsq	$7998890886330344604, %rbx
	jne	.LBB17_31
...
.LBB17_31:
	...
	je	.LBB17_168
	movq	%r15, %rcx
	movabsq	$-9038529977393613872, %r11
.LBB17_33:
	rep		bsfl	%esi, %esi
	addq	%rdi, %rsi
	andq	%rdx, %rsi
...
.LBB17_173:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$-9038529977393613872, %rdx
