	.file	"entity_insert_sparse.42a57c250b785340-cgu.0"
...
entity_insert:
	...
	testl	%eax, %eax
	je	.LBB7_148
	movabsq	$-5581976226739708329, %rbx
	movl	20(%r13), %ebp
	movl	24(%r13), %eax
	movq	%rax, 248(%rsp)
	movl	28(%r13), %eax
	...
	pcmpeqd	%xmm1, %xmm1
	movabsq	$-2600992813167080907, %r12
	movq	%rbx, %rdi
	movq	%r13, 288(%rsp)
	movl	%ebp, 32(%rsp)
	movl	%r14d, 28(%rsp)
...
.LBB7_8:
	...
	xorl	%esi, %esi
	pcmpeqd	%xmm1, %xmm1
	movabsq	$-5581976226739708329, %rdi
	movq	%rbx, %r8
.LBB7_10:
	andq	%rcx, %r8
	movdqu	(%rax,%r8), %xmm2
...
.LBB7_15:
	...
	xorl	%edi, %edi
	pcmpeqd	%xmm1, %xmm1
	movabsq	$-5581976226739708329, %r8
	movq	%rbx, %r9
.LBB7_16:
	andq	%rcx, %r9
	movdqu	(%rax,%r9), %xmm2
...
.LBB7_17:
	...
	xorq	%r8, %rbx
	movq	(%rsi,%rdx), %r12
	movabsq	$-2600992813167080907, %r14
	xorq	%r14, %r12
	orq	%rbx, %r12
	je	.LBB7_22
	leal	-1(%r10), %edx
...
.LBB7_33:
	...
	negq	%rdx
	leaq	(%rdx,%rdx,2), %rcx
	movabsq	$-2600992813167080907, %rdx
...
.LBB7_156:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$-2600992813167080907, %rcx
...
.Lanon.83959b72e5b8236df4a28836bf490603.9:
	.quad	-2600992813167080907
	.quad	-5581976226739708329
...
.Lanon.83959b72e5b8236df4a28836bf490603.10:
	...
	.size	.Lanon.83959b72e5b8236df4a28836bf490603.10, 23
