	.file	"entity_insert_sparse.f3cbc94681b2502e-cgu.0"
...
entity_insert:
	...
	testl	%ebp, %ebp
	je	.LBB17_168
	movabsq	$-5164016526867957422, %r10
	movabsq	$-7528279645303903842, %r14
	movl	20(%r13), %eax
	movl	%eax, 12(%rsp)
	movl	24(%r13), %r12d
	movl	28(%r13), %eax
...
.LBB17_17:
	...
	pcmpeqd	%xmm1, %xmm1
	movq	%r10, %r8
	movabsq	$-5164016526867957422, %rbx
.LBB17_18:
	andq	%rdx, %r8
	movdqu	(%rax,%r8), %xmm2
	movdqa	%xmm2, %xmm3
...
.LBB17_176:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$-7528279645303903842, %rdx
