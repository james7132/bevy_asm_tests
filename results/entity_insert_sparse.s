	.file	"entity_insert_sparse.4c401e971e7fc811-cgu.0"
...
entity_insert:
	...
	testl	%eax, %eax
	je	.LBB7_148
	movabsq	$5473593549759508295, %rbx
	movl	20(%r13), %ebp
	movl	24(%r13), %eax
	movq	%rax, 232(%rsp)
	movl	28(%r13), %eax
	...
	pcmpeqd	%xmm1, %xmm1
	movabsq	$9194116123227671773, %r12
	movq	%rbx, %rdi
	movq	%r13, 312(%rsp)
	movl	%ebp, 40(%rsp)
	movl	%r14d, 28(%rsp)
...
.LBB7_8:
	...
	xorl	%esi, %esi
	pcmpeqd	%xmm1, %xmm1
	movabsq	$5473593549759508295, %rdi
	movq	%rbx, %r8
.LBB7_10:
	andq	%rcx, %r8
	movdqu	(%rax,%r8), %xmm2
...
.LBB7_33:
	...
	negq	%rdx
	leaq	(%rdx,%rdx,2), %rcx
	movabsq	$9194116123227671773, %rdx
...
.LBB7_156:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$9194116123227671773, %rcx
...
.Lanon.83959b72e5b8236df4a28836bf490603.5:
	.quad	9194116123227671773
	.quad	5473593549759508295
