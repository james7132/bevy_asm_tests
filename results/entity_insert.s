	.file	"entity_insert.3efa313ba688da23-cgu.0"
...
entity_insert:
	...
	testl	%eax, %eax
	je	.LBB7_169
	movabsq	$8028891061015533807, %r11
	movq	248(%rsp), %rcx
	movl	20(%rcx), %ebx
	movl	24(%rcx), %r12d
	movl	28(%rcx), %eax
	...
	movq	%r13, 88(%rsp)
	movl	%ebx, 32(%rsp)
	movabsq	$7748309475011715013, %rbp
.LBB7_2:
	andq	%rcx, %rdi
	movdqu	(%rax,%rdi), %xmm2
	movdqa	%xmm2, %xmm3
...
.LBB7_8:
	...
	xorl	%esi, %esi
	pcmpeqd	%xmm1, %xmm1
	movabsq	$8028891061015533807, %rdi
	movq	%r11, %r8
	movabsq	$7748309475011715013, %rbp
.LBB7_10:
	andq	%rcx, %r8
...
.LBB7_15:
	...
	xorl	%edi, %edi
	pcmpeqd	%xmm1, %xmm1
	movabsq	$8028891061015533807, %r8
	movq	%r11, %r9
	movabsq	$7748309475011715013, %rbp
.LBB7_16:
	andq	%rcx, %r9
...
.LBB7_32:
	...
	movq	640(%r14), %rcx
	movq	%rcx, %rsi
	movabsq	$8028891061015533807, %r9
	andq	%r9, %rsi
	movdqu	(%rax,%rsi), %xmm0
	pmovmskb	%xmm0, %edx
	testl	%edx, %edx
	je	.LBB7_172
	movabsq	$7748309475011715013, %r10
.LBB7_34:
	rep		bsfl	%edx, %edx
	addq	%rsi, %rdx
	andq	%rcx, %rdx
...
.Lanon.83959b72e5b8236df4a28836bf490603.5:
	.quad	7748309475011715013
	.quad	8028891061015533807
