	.file	"entity_insert.fcf670b90a9faec6-cgu.0"
...
entity_insert:
	...
	testl	%eax, %eax
	je	.LBB7_203
	movabsq	$-5322528759364240965, %r15
	movabsq	$2859024748991744683, %r12
	movl	20(%r14), %r11d
	movl	24(%r14), %eax
	movq	%rax, 256(%rsp)
	movl	28(%r14), %eax
...
.LBB7_28:
	...
	movw	$256, 144(%rsp)
	movq	$1, 80(%rsp)
	movabsq	$2859024748991744683, %r13
	movq	%r13, 88(%rsp)
	movq	%r15, 96(%rsp)
	movq	$4, 120(%rsp)
	movq	$4, 128(%rsp)
...
.LBB7_36:
	...
	negq	%rdx
	leaq	(%rdx,%rdx,2), %rcx
	movabsq	$2859024748991744683, %rdx
...
.LBB7_211:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$2859024748991744683, %rcx
