	.file	"entity_insert.503026442eee81f8-cgu.0"
...
entity_insert:
	...
	testl	%eax, %eax
	je	.LBB7_169
	movabsq	$-6803845833913906631, %r11
	movl	20(%r13), %eax
	movl	%eax, 32(%rsp)
	movl	24(%r13), %r12d
	movl	28(%r13), %eax
	...
	pcmpeqd	%xmm1, %xmm1
	movabsq	$-4153873234759185158, %rbp
	movq	%r11, %rdi
	movq	%r12, 64(%rsp)
.LBB7_2:
	andq	%rdx, %rdi
...
.LBB7_9:
	...
	xorl	%esi, %esi
	pcmpeqd	%xmm1, %xmm1
	movabsq	$-6803845833913906631, %rdi
	movq	%r11, %r8
.LBB7_11:
	andq	%rcx, %r8
	movdqu	(%rax,%r8), %xmm2
...
.LBB7_28:
	...
	movups	168(%rsp), %xmm5
	movups	184(%rsp), %xmm6
	movups	%xmm6, 184(%r12,%r13)
	movups	%xmm5, 168(%r12,%r13)
	movups	%xmm4, 152(%r12,%r13)
	movdqu	%xmm3, 136(%r12,%r13)
	movdqu	%xmm2, 120(%r12,%r13)
	movdqu	%xmm1, 104(%r12,%r13)
	movdqu	%xmm0, 88(%r12,%r13)
	movq	%rbx, %r13
	movq	64(%rsp), %r12
	movq	24(%rsp), %rbx
	jmp	.LBB7_31
...
.LBB7_33:
	...
	movq	640(%r14), %rcx
	movq	%rcx, %rsi
	movabsq	$-6803845833913906631, %r9
	andq	%r9, %rsi
	movdqu	(%rax,%rsi), %xmm0
	pmovmskb	%xmm0, %edx
	testl	%edx, %edx
...
.LBB7_35:
	...
	negq	%rdx
	leaq	(%rdx,%rdx,2), %rcx
	movabsq	$-4153873234759185158, %rdx
...
.LBB7_169:
	.cfi_def_cfa_offset 416
	leaq	.Lanon.83959b72e5b8236df4a28836bf490603.3(%rip), %rsi
	movq	%r13, %rdi
...
.LBB7_177:
	...
	movq	%rbx, %rdi
	movq	%r12, %rsi
	movabsq	$-6803845833913906631, %rdx
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$-4153873234759185158, %rcx
	movq	%rcx, -24(%rbx,%rax,8)
	movabsq	$-6803845833913906631, %rcx
...
.Lanon.83959b72e5b8236df4a28836bf490603.0:
	...
	.size	.Lanon.83959b72e5b8236df4a28836bf490603.0, 106
...
.Lanon.83959b72e5b8236df4a28836bf490603.2:
	...
	.size	.Lanon.83959b72e5b8236df4a28836bf490603.2, 116
...
.Lanon.83959b72e5b8236df4a28836bf490603.4:
	.quad	.Lanon.83959b72e5b8236df4a28836bf490603.2
	.asciz	"s\000\000\000\000\000\000\000\240\003\000\000\024\000\000"
...
.Lanon.83959b72e5b8236df4a28836bf490603.5:
	.quad	-4153873234759185158
	.quad	-6803845833913906631
...
.Lanon.83959b72e5b8236df4a28836bf490603.7:
	.asciz	"/home/james/.cargo/git/checkouts/bevy-50d7e162b728c6c6/e3814a9/crates/bevy_ecs/src/bundle/insert.rs"
