	.file	"entity_remove_sparse.e937e36c08dfcc39-cgu.0"
...
.Lfunc_begin6:
	...
	testl	%eax, %eax
	je	.LBB20_214
	movabsq	$-1314182736023122625, %rbx
	movabsq	$-5398190768512577959, %r11
	movl	20(%rdi), %eax
	movl	%eax, 44(%rsp)
	movl	24(%rdi), %r15d
	movq	(%rdi), %r13
...
.LBB20_40:
	...
	movw	$257, 160(%rsp)
	movq	$1, 96(%rsp)
	movabsq	$-1314182736023122625, %rax
	movq	%rax, 104(%rsp)
	movabsq	$-5398190768512577959, %rax
	movq	%rax, 112(%rsp)
	movq	$4, 136(%rsp)
	movq	$4, 144(%rsp)
	movq	$0, 152(%rsp)
...
.LBB20_51:
	...
	leaq	80(%r13), %rdi
.Ltmp80:
	movabsq	$-1314182736023122625, %rsi
	movabsq	$-5398190768512577959, %rdx
	movq	%rbp, %rcx
	callq	hashbrown::map::HashMap<K,V,S,A>::insert
.Ltmp81:
.Ltmp82:
...
.Ltmp103:
	movq	56(%rsp), %rdi
	cmpq	(%rdi), %r14
	movabsq	$-5398190768512577959, %rbx
	jne	.LBB20_21
.Ltmp104:
...
.LBB20_26:
	...
	negq	%rdx
	leaq	(%rdx,%rdx,2), %rcx
	movabsq	$-1314182736023122625, %rdx
...
.Ltmp111:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$-1314182736023122625, %rcx
	movq	%rcx, -24(%rbx,%rax,8)
	movabsq	$-5398190768512577959, %rcx
...
.Lanon.ddd9cd1641521d33379e20f985469fcb.22:
	...
	.size	.Lanon.ddd9cd1641521d33379e20f985469fcb.22, 23
