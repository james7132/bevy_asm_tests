	.file	"entity_remove_sparse.2aa09a046d7e869d-cgu.0"
...
entity_remove:
	...
	testl	%r11d, %r11d
	je	.LBB8_75
	movabsq	$-6155238777092508030, %rbp
	movabsq	$-7617354864261801442, %r14
	movl	20(%rdi), %eax
	movl	%eax, 36(%rsp)
	movl	24(%rdi), %r15d
	movq	(%rdi), %rbx
...
.LBB8_38:
	...
	negq	%rdx
	leaq	(%rdx,%rdx,2), %rcx
	movabsq	$-7617354864261801442, %rdx
...
.LBB8_40:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$-7617354864261801442, %rcx
...
.Lanon.ddd9cd1641521d33379e20f985469fcb.8:
	.quad	.Lanon.ddd9cd1641521d33379e20f985469fcb.6
	.asciz	"g\000\000\000\000\000\000\000\361\b\000\000\024\000\000"
...
.Lanon.ddd9cd1641521d33379e20f985469fcb.44:
	...
	.size	.Lanon.ddd9cd1641521d33379e20f985469fcb.44, 119
