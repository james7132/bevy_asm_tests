	.file	"entity_remove_sparse.27f46c651bacb2a9-cgu.0"
...
entity_remove:
	...
	je	.LBB8_147
	movl	%eax, 220(%rsp)
	movabsq	$-3024423720656266238, %rbp
	movl	20(%rbx), %eax
	movl	%eax, 28(%rsp)
	movl	24(%rbx), %r15d
	movq	(%rbx), %r14
	...
	pcmpeqd	%xmm1, %xmm1
	movabsq	$-7082630975420631934, %r13
	movq	%rbp, %rdi
	movq	%rbx, 72(%rsp)
	movq	%r14, (%rsp)
.LBB8_2:
...
.LBB8_8:
	...
	xorl	%esi, %esi
	pcmpeqd	%xmm1, %xmm1
	movabsq	$-3024423720656266238, %rdi
	movq	%rbp, %r8
.LBB8_10:
	andq	%rcx, %r8
	movdqu	(%rax,%r8), %xmm2
...
.LBB8_15:
	...
	xorl	%edi, %edi
	pcmpeqd	%xmm1, %xmm1
	movabsq	$-3024423720656266238, %r8
	movq	%rbp, %r9
.LBB8_16:
	andq	%rcx, %r9
	movdqu	(%rax,%r9), %xmm2
...
.LBB8_34:
	...
	negq	%rdx
	leaq	(%rdx,%rdx,2), %rcx
	movabsq	$-7082630975420631934, %rdx
...
.LBB8_157:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$-7082630975420631934, %rcx
...
.Lanon.ddd9cd1641521d33379e20f985469fcb.5:
	.quad	-7082630975420631934
	.quad	-3024423720656266238
