	.file	"entity_remove.a59d47b44207f82d-cgu.0"
...
entity_remove:
	...
	je	.LBB8_74
	movl	%eax, 228(%rsp)
	movabsq	$6238940888798229283, %rbp
	movl	20(%rdi), %eax
	movl	%eax, 36(%rsp)
	movl	24(%rdi), %r15d
	movq	(%rdi), %rcx
	...
	pcmpeqd	%xmm1, %xmm1
	movabsq	$7557410014145371135, %r13
	movq	%rbp, %rbx
	movq	%rdi, 176(%rsp)
.LBB8_2:
	andq	%rcx, %rbx
...
.LBB8_7:
	...
	xorl	%esi, %esi
	pcmpeqd	%xmm1, %xmm1
	movabsq	$6238940888798229283, %r14
	movq	%rbp, %r8
.LBB8_9:
	andq	%rcx, %r8
	movdqu	(%rax,%r8), %xmm2
...
.LBB8_15:
	...
	xorl	%r13d, %r13d
	pcmpeqd	%xmm1, %xmm1
	movabsq	$6238940888798229283, %r8
	movq	%rbp, %r9
	movabsq	$7557410014145371135, %rdi
.LBB8_16:
	andq	%rcx, %r9
	movdqu	(%rax,%r9), %xmm2
	movdqa	%xmm2, %xmm3
...
.LBB8_31:
	...
	pmovmskb	%xmm0, %edx
	testl	%edx, %edx
	movabsq	$7557410014145371135, %r9
	je	.LBB8_32
.LBB8_34:
	rep		bsfl	%edx, %edx
	addq	%rsi, %rdx
...
.LBB8_38:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$7557410014145371135, %rcx
...
.Lanon.ddd9cd1641521d33379e20f985469fcb.11:
	.quad	7557410014145371135
	.quad	6238940888798229283
