	.file	"entity_remove.9832845f0ea73e6e-cgu.0"
...
entity_remove:
	...
	testl	%r11d, %r11d
	je	.LBB8_75
	movabsq	$-7972547094914637598, %r14
	movabsq	$2196593613866161583, %rbp
	movl	20(%rdi), %eax
	movl	%eax, 36(%rsp)
	movl	24(%rdi), %r15d
	movq	(%rdi), %rbx
...
.LBB8_38:
	...
	negq	%rdx
	leaq	(%rdx,%rdx,2), %rcx
	movabsq	$-7972547094914637598, %rdx
...
.LBB8_40:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$-7972547094914637598, %rcx
