	.file	"entity_remove.ff426948b104c5fc-cgu.0"
...
entity_remove:
	...
	testl	%r11d, %r11d
	je	.LBB15_165
	movabsq	$4033825565383433714, %r14
	movabsq	$3054504378995290576, %r13
	movl	20(%rbx), %eax
	movl	%eax, 44(%rsp)
	movl	24(%rbx), %r15d
	movq	(%rbx), %rbp
...
.LBB15_37:
	...
	negq	%rdx
	leaq	(%rdx,%rdx,2), %rcx
	movabsq	$4033825565383433714, %rdx
...
.LBB15_41:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$4033825565383433714, %rcx
