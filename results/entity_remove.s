	.file	"entity_remove.91ef0644a3288e3c-cgu.0"
...
entity_remove:
	...
	testl	%ebp, %ebp
	je	.LBB8_51
	movabsq	$-8081861452551241148, %r15
	movl	20(%rbx), %eax
	movl	%eax, 84(%rsp)
	movl	24(%rbx), %r12d
	movq	(%rbx), %rcx
	...
	pcmpeqd	%xmm1, %xmm1
	movabsq	$423166746739028304, %r14
	movq	%r15, %rdi
	movq	%rbx, 64(%rsp)
	movl	%ebp, 220(%rsp)
.LBB8_2:
...
.LBB8_7:
	...
	xorl	%esi, %esi
	pcmpeqd	%xmm1, %xmm1
	movabsq	$-8081861452551241148, %rdi
	movq	%r15, %r8
.LBB8_9:
	andq	%rcx, %r8
	movdqu	(%rax,%r8), %xmm2
...
.LBB8_15:
	...
	xorl	%edi, %edi
	pcmpeqd	%xmm1, %xmm1
	movabsq	$-8081861452551241148, %r8
	movq	%r15, %r9
	movabsq	$423166746739028304, %rbp
.LBB8_16:
	andq	%rcx, %r9
	movdqu	(%rax,%r9), %xmm2
	movdqa	%xmm2, %xmm3
...
.LBB8_35:
	...
	negq	%rdx
	leaq	(%rdx,%rdx,2), %rcx
	movabsq	$423166746739028304, %rdx
...
.LBB8_37:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$423166746739028304, %rcx
...
.Lanon.ddd9cd1641521d33379e20f985469fcb.5:
	.quad	423166746739028304
	.quad	-8081861452551241148
