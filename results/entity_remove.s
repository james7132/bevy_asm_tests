	.file	"entity_remove.c8b0a18039b77c66-cgu.0"
...
entity_remove:
	...
	testl	%r11d, %r11d
	je	.LBB8_75
	movabsq	$-5374388435141589455, %rbp
	movabsq	$-5395901711431604785, %r14
	movl	20(%rdi), %eax
	movl	%eax, 36(%rsp)
	movl	24(%rdi), %r15d
	movq	(%rdi), %rbx
...
.LBB8_38:
	...
	negq	%rdx
	leaq	(%rdx,%rdx,2), %rcx
	movabsq	$-5395901711431604785, %rdx
...
.LBB8_40:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$-5395901711431604785, %rcx
