	.text
	.file	"query_state_for_each.ad7f2a3a55f8580f-cgu.0"
...
.Ltmp7:
	...
	ud2
.Lfunc_end1:
	.size	core::ptr::drop_in_place<bevy_ecs::query::state::QueryState<(&mut query_state_for_each::A,&query_state_for_each::B)>>, .Lfunc_end1-core::ptr::drop_in_place<bevy_ecs::query::state::QueryState<(&mut query_state_for_each::A,&query_state_for_each::B)>>
	.cfi_endproc
...
.LBB7_3:
	...
	imulq	$152, %rdi, %rdi
	movq	296(%r15), %rax
	movq	136(%rdx,%rdi), %rcx
	cmpq	%rax, %rcx
	jbe	.LBB7_46
	movq	128(%rdx,%rdi), %rbx
	testq	%rbx, %rbx
	je	.LBB7_46
	shlq	$4, %rax
	cmpq	$0, (%rbx,%rax)
...
.Ltmp34:
	...
	ud2
.Lfunc_end7:
	.size	query_state_for_each, .Lfunc_end7-query_state_for_each
	.cfi_endproc
