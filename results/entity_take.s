	.file	"entity_take.5761306e5f2b2c50-cgu.0"
...
entity_remove:
	...
	testl	%ebx, %ebx
	je	.LBB15_174
	movabsq	$-7231815447531249589, %rbp
	movabsq	$7274504475060741495, %r14
	movl	20(%rdi), %eax
	movl	%eax, 28(%rsp)
	movl	24(%rdi), %r12d
	movq	8(%rdi), %rax
...
.LBB15_28:
	...
	movw	$256, 112(%rsp)
	movq	$1, 48(%rsp)
	movabsq	$-7231815447531249589, %rbx
	movq	%rbx, 56(%rsp)
	movabsq	$7274504475060741495, %r14
	movq	%r14, 64(%rsp)
	movq	$4, 88(%rsp)
...
.LBB15_33:
	...
	movq	640(%r15), %rcx
	movq	%rcx, %rsi
	movabsq	$7274504475060741495, %rbp
	andq	%rbp, %rsi
	movdqu	(%rax,%rsi), %xmm0
	pmovmskb	%xmm0, %edx
	testl	%edx, %edx
...
.LBB15_37:
	...
	negq	%rdx
	leaq	(%rdx,%rdx,2), %rcx
	movabsq	$-7231815447531249589, %rdx
...
.LBB15_41:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$-7231815447531249589, %rcx
	movq	%rcx, -24(%r15,%rax,8)
	movabsq	$7274504475060741495, %rcx
