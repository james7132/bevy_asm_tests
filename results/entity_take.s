	.file	"entity_take.82fd9b290a8ae80d-cgu.0"
...
.LBB3_34:
	...
	movq	$8, 72(%rsp)
	movq	$0, 80(%rsp)
	movdqu	.Lanon.ddd9cd1641521d33379e20f985469fcb.60(%rip), %xmm0
	movdqu	%xmm0, 88(%rsp)
	movdqu	.Lanon.ddd9cd1641521d33379e20f985469fcb.60+16(%rip), %xmm1
	movdqu	%xmm1, 104(%rsp)
	movq	$0, 120(%rsp)
	movq	$8, 128(%rsp)
	movq	$0, 136(%rsp)
...
.Lfunc_begin6:
	...
	je	.LBB20_221
	movl	%eax, 268(%rsp)
	movabsq	$-9152838466745202543, %rbx
	movabsq	$9210325275547421066, %r11
	movl	20(%rdi), %eax
	movl	%eax, 36(%rsp)
	movl	24(%rdi), %r12d
	movq	8(%rdi), %rax
...
.LBB20_40:
	...
	movw	$256, 144(%rsp)
	movq	$1, 80(%rsp)
	movabsq	$-9152838466745202543, %rax
	movq	%rax, 88(%rsp)
	movabsq	$9210325275547421066, %rax
	movq	%rax, 96(%rsp)
	movq	$4, 120(%rsp)
	movq	$4, 128(%rsp)
	movq	$0, 136(%rsp)
...
.LBB20_51:
	...
	leaq	80(%r14), %rdi
.Ltmp80:
	movabsq	$-9152838466745202543, %rsi
	movabsq	$9210325275547421066, %rdx
	movq	%rbp, %rcx
	callq	hashbrown::map::HashMap<K,V,S,A>::insert
.Ltmp81:
.Ltmp82:
...
.Ltmp103:
	movq	64(%rsp), %rdi
	cmpq	(%rdi), %rbx
	movabsq	$9210325275547421066, %r15
	jne	.LBB20_21
.Ltmp104:
...
.LBB20_26:
	...
	negq	%rdx
	leaq	(%rdx,%rdx,2), %rcx
	movabsq	$-9152838466745202543, %rdx
...
.Ltmp111:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$-9152838466745202543, %rcx
