...
.Lfunc_begin1:
	...
	.cfi_offset %r15, -24
	.cfi_offset %rbp, -16
	movabsq	$8910658123557452324, %r12
	movabsq	$1449757869704625908, %r14
	movq	%rdi, 160(%rsp)
	movq	24(%rdi), %r15
	leaq	64(%r15), %rax
	movq	%rax, 32(%rsp)
...
.LBB18_98:
	...
	addq	$136, %r9
	decq	%rcx
	movq	128(%r12,%rdi), %rax
	leaq	(%r10,%r10,2), %rbp
	movl	8(%rax,%rbp,4), %r14d
	leaq	(%rcx,%rcx,2), %rdx
	...
	je	.LBB18_104
	movq	12(%rcx), %rcx
	movl	%ebp, 4(%r13,%rax,4)
	movl	%r10d, 8(%r13,%rax,4)
	movq	%rcx, 12(%r13,%rax,4)
.LBB18_106:
	movl	28(%rsp), %eax
	cmpq	%rax, %r11
	jbe	.LBB18_107
	movl	144(%r12,%rdi), %edi
	imulq	$152, %rax, %rbp
	leaq	(%r12,%rbp), %rcx
	addq	$144, %rcx
	movl	144(%r12,%rbp), %eax
	cmpl	%eax, %edi
	jne	.LBB18_109
	leaq	(%r12,%rbp), %r15
	addq	$136, %r15
	movq	136(%r12,%rbp), %rbx
	movq	%rbx, %rax
	cmpq	120(%r12,%rbp), %rbx
	jne	.LBB18_132
	leaq	(%r12,%rbp), %rdi
	addq	$120, %rdi
	movq	%rbx, %rsi
...
.LBB18_125:
	...
	movl	8(%rbp), %eax
	movl	12(%rbp), %ebp
	movl	%ecx, 4(%r13,%rsi,4)
	movl	%eax, 8(%r13,%rsi,4)
	movl	%ebp, 12(%r13,%rsi,4)
	movq	48(%rsp), %rbp
	movl	%ebp, 16(%r13,%rsi,4)
	movq	152(%rsp), %rsi
	cmpq	%rcx, %rsi
	jbe	.LBB18_143
	imulq	$152, %rcx, %rcx
	movq	136(%r12,%rcx), %rsi
	cmpq	%rax, %rsi
	jbe	.LBB18_144
	addq	%r12, %rcx
	addq	$120, %rcx
...
.LBB18_137:
	...
	movl	%ebx, 8(%r13,%rax,4)
	movl	%edi, 12(%r13,%rax,4)
	movl	%r14d, 16(%r13,%rax,4)
	movl	$1, %ebx
.LBB18_138:
	movl	%ebx, 64(%rsp)
	movss	%xmm0, 68(%rsp)
