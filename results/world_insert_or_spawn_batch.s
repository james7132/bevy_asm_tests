	.text
	.file	"world_insert_or_spawn_batch.a9a96433374b893f-cgu.0"
...
.Ltmp7:
	...
	addq	160(%rsp), %rax
	movq	%rax, 296(%rsp)
	movabsq	$3281715536486379658, %rdx
	movl	776(%rbp), %eax
	movl	%eax, 44(%rsp)
	leaq	488(%rbp), %rbx
	leaq	64(%rbp), %rax
...
.LBB12_56:
	.cfi_def_cfa_offset 400
	movabsq	$-4241464350725728545, %rax
	movabsq	$8415890149946031833, %rcx
	movq	$0, 16(%rsp)
	leaq	24(%rsp), %rdx
	movq	%rdx, 168(%rsp)
	movq	$8, 24(%rsp)
...
.Ltmp12:
	...
	callq	alloc::raw_vec::RawVec<T,A>::reserve_for_push
.Ltmp13:
	movabsq	$-5606354614968012617, %rax
	movabsq	$8042414476338275286, %rcx
	movq	24(%rsp), %rsi
	movq	32(%rsp), %rdx
	movq	%rsi, 56(%rsp)
	movq	%r15, (%rsi,%rdx,8)
...
.LBB12_79:
	...
	movq	%rax, 504(%rbp)
	movq	%r14, %rcx
	movabsq	$3281715536486379658, %rax
	andq	%rax, %rcx
	movdqu	(%r13,%rcx), %xmm0
	pmovmskb	%xmm0, %eax
	testl	%eax, %eax
...
.LBB12_92:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$3281715536486379658, %rcx
	movq	%rcx, -24(%r13,%rax,8)
	movabsq	$3464490383624226921, %rcx
