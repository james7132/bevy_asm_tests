	.text
	.file	"world_insert_or_spawn_batch.f4f564f1-cgu.0"
...
.Ltmp7:
	movabsq	$-6627734012963248385, %r13
	movabsq	$6678616652907260011, %r15
	movl	888(%r14), %eax
	movl	%eax, 60(%rsp)
	leaq	472(%r14), %rax
	movq	%rax, 64(%rsp)
...
.LBB18_8:
	movq	%r14, %rcx
	movabsq	$7140742303989813571, %r14
	movabsq	$5120891341068200447, %rsi
	movq	$0, 176(%rsp)
	movq	$8, 184(%rsp)
	movq	$0, 192(%rsp)
	leaq	536(%rcx), %rax
...
.Ltmp20:
	...
	callq	alloc::raw_vec::RawVec<T,A>::reserve_for_push
.Ltmp21:
	movabsq	$-5567312162897019914, %rsi
	movabsq	$1133325344120464542, %r14
	movq	184(%rsp), %rcx
	movq	192(%rsp), %rax
	movq	%rcx, 24(%rsp)
	movq	%rbp, (%rcx,%rax,8)
...
.LBB18_35:
	...
	movq	472(%rdi), %rcx
	movq	496(%rdi), %rax
	movabsq	$5120891341068200447, %rdi
	andq	%rcx, %rdi
	movdqu	(%rax,%rdi), %xmm0
	pmovmskb	%xmm0, %edx
	testl	%edx, %edx
...
.LBB18_60:
	...
	movq	472(%rdi), %rcx
	movq	496(%rdi), %rax
	movabsq	$-5567312162897019914, %rdi
	andq	%rcx, %rdi
	movdqu	(%rax,%rdi), %xmm0
	pmovmskb	%xmm0, %edx
	testl	%edx, %edx
