	.text
	.file	"world_insert_or_spawn_batch.b176f179e2a87ded-cgu.0"
...
.Ltmp1:
	...
	addq	96(%rsp), %rax
	movq	%rax, 360(%rsp)
	movabsq	$6122482544350720285, %rbp
	movl	760(%r15), %eax
	movl	%eax, 76(%rsp)
	leaq	488(%r15), %rbx
	leaq	64(%r15), %rax
...
.LBB9_8:
	movq	%r15, %rax
	movabsq	$1258634908193920729, %r15
	movabsq	$2895141423492605088, %r14
	movabsq	$-3209860858793094880, %rdx
	movq	$8, 32(%rsp)
	leaq	88(%rax), %rcx
	movq	%rcx, 104(%rsp)
	pxor	%xmm0, %xmm0
...
.Ltmp8:
	...
	callq	alloc::raw_vec::RawVec<T,A>::reserve_for_push
.Ltmp9:
	movabsq	$7691792183645449712, %r14
	movabsq	$7929936699246226644, %r15
	movabsq	$3532249752718532452, %rdx
	movq	32(%rsp), %rcx
	movq	48(%rsp), %rax
	movq	%rcx, 112(%rsp)
	movq	24(%rsp), %rsi
...
.LBB9_64:
	...
	movzbl	%dil, %edi
	subq	%rdi, 528(%r15)
	movabsq	$4239473944078103145, %rdi
	movq	%rdi, -24(%rcx,%rdx,8)
	movabsq	$2309715233392142558, %rdi
...
.LBB9_20:
	...
	movq	88(%rdi), %rax
	movq	96(%rdi), %r12
	movabsq	$-3209860858793094880, %rdi
	andq	%r12, %rdi
	movq	%rax, %rdx
	movdqu	(%rax,%rdi), %xmm0
	pmovmskb	%xmm0, %eax
...
.LBB9_39:
	...
	movq	88(%rdi), %rax
	movq	96(%rdi), %rcx
	movabsq	$3532249752718532452, %rdi
	andq	%rcx, %rdi
	movdqu	(%rax,%rdi), %xmm0
	pmovmskb	%xmm0, %edx
	testl	%edx, %edx
