	.text
	.file	"world_insert_or_spawn_batch.cd8542fd9ed44bc8-cgu.0"
...
.Ltmp1:
	...
	addq	112(%rsp), %rax
	movq	%rax, 400(%rsp)
	movabsq	$-2862212920241442931, %rbx
	movl	760(%r12), %eax
	movl	%eax, 68(%rsp)
	leaq	488(%r12), %rbp
	leaq	64(%r12), %rax
...
.Ltmp3:
.LBB14_49:
	movabsq	$6268199135016751140, %r14
	movq	%r12, %rax
	movabsq	$4607175669638243513, %r12
	movabsq	$1483530193445493165, %rdx
	movq	$8, 72(%rsp)
	pxor	%xmm0, %xmm0
	movdqu	%xmm0, 80(%rsp)
	leaq	88(%rax), %rcx
...
.Ltmp14:
	...
	callq	alloc::raw_vec::RawVec<T,A>::reserve_for_push
.Ltmp15:
	movabsq	$1356335852763435850, %r12
	movabsq	$306296533030761587, %r14
	movabsq	$-4672791147151801105, %rdx
	movq	72(%rsp), %rax
	movq	88(%rsp), %rcx
	movq	%rax, 48(%rsp)
	movq	24(%rsp), %rsi
...
.LBB14_75:
	...
	movzbl	%dil, %esi
	subq	%rsi, 528(%r12)
	movabsq	$5583115425410534169, %rsi
	movq	%rsi, -24(%rcx,%rdx,8)
	movabsq	$8291659707604104094, %rsi
...
.LBB14_84:
	...
	movq	88(%rdi), %rax
	movq	96(%rdi), %r15
	movabsq	$1483530193445493165, %rdi
	andq	%r15, %rdi
	movq	%rax, %rdx
	movdqu	(%rax,%rdi), %xmm0
	pmovmskb	%xmm0, %eax
...
.Ltmp19:
	movq	%r15, 16(%rsp)
	cmpb	$0, 328(%rsp)
	movabsq	$-4672791147151801105, %r15
	je	.LBB14_95
.Ltmp20:
	leaq	256(%rsp), %rsi
	movq	120(%rsp), %rdi
