	.text
	.file	"world_insert_or_spawn_batch.95615d74e5fee99b-cgu.0"
...
.Ltmp7:
	...
	addq	152(%rsp), %rax
	movq	%rax, 296(%rsp)
	movabsq	$-4764904313705278717, %rdx
	movl	848(%r15), %eax
	movl	%eax, 52(%rsp)
	leaq	488(%r15), %r14
	leaq	64(%r15), %rax
...
.LBB12_75:
	.cfi_def_cfa_offset 400
	movabsq	$7911389163839255358, %rax
	movabsq	$1549586744478652416, %rcx
	movq	$0, 16(%rsp)
	leaq	24(%rsp), %rdx
	movq	%rdx, 160(%rsp)
	movq	$8, 24(%rsp)
...
.Ltmp12:
	...
	callq	alloc::raw_vec::RawVec<T,A>::reserve_for_push
.Ltmp13:
	movabsq	$4408002728458052919, %rax
	movabsq	$1232434260083683900, %rcx
	movq	24(%rsp), %rsi
	movq	32(%rsp), %rdx
	movq	%rsi, 64(%rsp)
	movq	%r15, (%rsi,%rdx,8)
...
.LBB12_98:
	...
	movq	%rax, 504(%rsi)
	movq	%r12, %rcx
	movabsq	$-4764904313705278717, %rax
	andq	%rax, %rcx
	movdqu	(%rbx,%rcx), %xmm0
	pmovmskb	%xmm0, %eax
	testl	%eax, %eax
...
.LBB12_111:
	...
	negq	%rax
	leaq	(%rax,%rax,2), %rax
	movabsq	$-4764904313705278717, %rcx
	movq	%rcx, -24(%rbx,%rax,8)
	movabsq	$5665247705516112115, %rcx
