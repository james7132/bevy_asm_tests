	.file	"resource_insert.6239d79544cd7106-cgu.0"
...
resource_insert:
	...
	movd	%xmm0, 20(%rsp)
	movq	%rdi, %rbx
	movabsq	$-372927465861147309, %rbp
	movabsq	$-1641380425722106327, %r12
	leaq	56(%rdi), %r15
	leaq	1440(%rdi), %rax
	movq	%r15, 48(%rsp)
	movq	%rax, 56(%rsp)
...
.LBB2_19:
	movq	64(%rbx), %rax
.LBB2_25:
	movabsq	$-1641380425722106327, %r13
	leaq	(%r14,%r14,8), %rcx
	shlq	$5, %rcx
	leaq	(%rax,%rcx), %r15
	cmpl	$2, (%rax,%rcx)
...
.Lanon.7389e6565b10821dad2f4dd8892551e5.0:
	...
	.size	.Lanon.7389e6565b10821dad2f4dd8892551e5.0, 118
...
.Lanon.7389e6565b10821dad2f4dd8892551e5.2:
	.quad	-1641380425722106327
	.quad	-372927465861147309
...
.Lanon.7389e6565b10821dad2f4dd8892551e5.7:
	.asciz	"/home/james/.cargo/git/checkouts/bevy-91340e2100a853f9/606794e/crates/bevy_ecs/src/storage/resource.rs"
